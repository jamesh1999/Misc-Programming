...
#include "../../CodeBreakerGUI/GlobalSettings.h"
...
QT_MOC_LITERAL(3, 38, 26) // "on_tableWidget_cellChanged"

    },
    "GlobalSettings\0on_pushButton_clicked\0"
    "\0on_tableWidget_cellChanged"
};
...
const QMetaObject GlobalSettings::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_GlobalSettings.data,
      qt_meta_data_GlobalSettings,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GlobalSettings::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::Dialog"))
        return static_cast< Ui::Dialog*>(const_cast< GlobalSettings*>(this));
