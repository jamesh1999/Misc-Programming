...
$config['item']['id']             = 'itm-id';    // Item id
$config['item']['name']           = 'itm-name';    // Item name
$config['item']['price']          = 'itm-price';    // Item price
$config['item']['qty']            = 'itm-qty';    // Item quantity
$config['item']['url']            = 'itm-url';    // Item URL (optional)
...
$config['paypal']['id']           = 'KAX9FQPZVKBDL';
...
$config['text']['cartTitle']      = 'Checkout';    // Shopping Cart
